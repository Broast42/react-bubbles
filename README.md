...
- [ ] Explain what a token is used for.
  A token is used as a authorization method. When a user successfully signs in a token is saved to local storage and then can be used to access private routs.

- [ ] What steps can you take in your web apps to keep your data secure?
    Always use web tokens and be sure to make any component that may have sensitive data only assessable through a private route.

- [ ] Describe how web servers work.
  Web servers are physical pc or software that serve data via networks and http requests. 

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
   CRUD stands for Create Read Update Delete. Create uses the Post method, Read uses the Get method, Update uses a Put request and Delete uses a Delete request.
